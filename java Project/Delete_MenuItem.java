...
public class Delete_MenuItem {
    ...
    Delete_MenuItem() {
        ...
        /**** Background ****/
        ImageIcon background_image= new ImageIcon("delete.jpg");
        ...
        del.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
             ...
             try {
                 BufferedWriter tempWriter = new BufferedWriter(new FileWriter("temp.txt",false));
                 ...
                 BufferedWriter menuWriter = new BufferedWriter(new FileWriter("menu.txt"));
